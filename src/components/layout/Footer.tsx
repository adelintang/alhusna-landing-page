import type { FooterProps, FooterData, SocialIconType } from "../../types/footer.types";
...
export const Footer = ({
  ...
  const { brand, quickLinks, programs, contact, socialMedia, copyright, bottomLinks } = data;
