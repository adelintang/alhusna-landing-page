    ...
    <footer className="bg-midnight text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex gap-3">
              {socialMedia.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary transition-all"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-sans text-base font-semibold text-white mb-4">
              {quickLinks.title}
            </h3>
            <ul className="space-y-3">
              {quickLinks.links.map((link) => (
                <li key={link.id}>
                  <a
                    href={link.href}
                    className="font-sans text-sm text-gray-400 hover:text-primary transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="font-sans text-sm text-gray-400">{copyright}</p>
